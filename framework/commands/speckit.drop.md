---
description: stop a request: a queue instruction applied at answer, or a stop at the current gate
...
2. This is an entry command: `python3 framework/tools/orchestrate.py start changes/<YYYY-MM-DD>-<n>-<slug>.md --command speckit.drop`, with the PM's words (`$ARGUMENTS`) written under `## Request`.
