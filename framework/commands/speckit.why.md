---
description: why does it behave this way: sorted as a question, answered from the decision log first
...
2. This is an entry command: `python3 framework/tools/orchestrate.py start changes/<YYYY-MM-DD>-<n>-<slug>.md --command speckit.why`, with the PM's words (`$ARGUMENTS`) written under `## Request`.
