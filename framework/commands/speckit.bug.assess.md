---
description: report a bug; sorted as a fix when the violated criterion can be named; traced without touching code
...
2. This is an entry command: `python3 framework/tools/orchestrate.py start changes/<YYYY-MM-DD>-<n>-<slug>.md --command speckit.bug.assess`, with the PM's words (`$ARGUMENTS`) written under `## Request`.
