---
description: where is everything: sorted as a question, answered from the queue
...
2. This is an entry command: `python3 framework/tools/orchestrate.py start changes/<YYYY-MM-DD>-<n>-<slug>.md --command speckit.status`, with the PM's words (`$ARGUMENTS`) written under `## Request`.
